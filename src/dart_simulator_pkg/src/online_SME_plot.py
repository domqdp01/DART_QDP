...
class SetMembershipOnline:
    ...
    def setup_plot(self):
        ...
        self.ax.set_xlabel('')
        self.ax.set_ylabel('μ', fontsize=15)
        self.ax.set_ylim(0.4, 0.9)
    ...
    def run_plot(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.ax.set_title(f'μ ∈ [{mu_min:.3f}, {mu_max:.3f}]', fontsize=20)
